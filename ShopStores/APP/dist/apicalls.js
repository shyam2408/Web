...
export function AddNewProduct(product) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield fetch("http://localhost:5345/api/grocerystore/productscontroller/add/newProduct", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
export function CheckProductExist(productName) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield fetch(`http://localhost:5345/api/grocerystore/productscontroller/product/${productName}`);
        if (!response.ok) {
            throw new Error("Fail to fetch data");
        }
        return yield response.json();
...
export function EditProductDetail(product) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield fetch(`http://localhost:5345/api/grocerystore/productscontroller/new/prod/edit`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
...
export function AddItemToCart(cartItem) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield fetch("http://localhost:5345/api/grocerystore/cartController/add/cartItem", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
export function UpdateCartQuantity(customerID, cartID, quantity) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield fetch(`http://localhost:5345/api/grocerystore/cartController/update/cart/${customerID}/${cartID}/${quantity}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            }
...
export function FetchCarts(customerID) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield fetch(`http://localhost:5345/api/grocerystore/cartController/carts/${customerID}`);
        if (!response.ok) {
            throw new Error("Fail to fetch data");
        }
        return yield response.json();
...
export function DeleteCartDetail(customerID, cartID) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`http://localhost:5345/api/grocerystore/cartController/delete/newcart/${customerID}/${cartID}`, {
            method: 'DELETE'
        });
        if (!response.ok) {
            throw new Error('Failed to delete contact');
...
export function BuySingleItem(cartID, customerID) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`http://localhost:5345/api/grocerystore/purchaseController/new/singleBooking/${cartID}/${customerID}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            }
...
export function cancelBooking(bookingID, customerID) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`http://localhost:5345/api/grocerystore/purchaseController/cancel/booking/${bookingID}/${customerID}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            }
