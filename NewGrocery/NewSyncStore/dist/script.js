...
function home() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // welcome.innerHTML = "Welcome " + currentCustomer.name;
    });
}
function CustomerDetails() {
    ...
    <table class="profile-table">
        ...
        <tr>
            <th>Mobile Number</th>
            <td>${currentCustomer.mobileNumber}</td>
        </tr>
        <tr>
            <th>Mail ID</th>
...
function editProduct(e) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (currentProduct != null) {
            ...
            //await EditProductDetail(currentProduct.productID, productName, quantityAvailable, pricePerQuantity, productPhotoBase64);
